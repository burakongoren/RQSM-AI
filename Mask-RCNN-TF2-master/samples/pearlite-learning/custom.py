...
DATASET_DIRECTORY = os.path.join(ROOT_DIR, "/samples/pearlite-learning/Dataset")
...
WEIGHTS_PATH = os.path.join(ROOT_DIR, "/samples/pearlite-learning")
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR ,"/samples/pearlite-learning")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect microstructures.')
    ...
    if args.command == "train":
        ...
        class InferenceConfig(PearliteConfig):
